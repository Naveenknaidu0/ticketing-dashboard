...
const serviceDeskReports = [
  { id: 'group-performance', name: 'Group Performance', path: '/reports/service-desk/group-performance', icon: BarChart3 },
]
    ...
    <AppShell>
      <div className="flex flex-col h-full">
        <div className="border-b p-6" style={{ borderColor: '#E2E0DC' }}>
          ...
          <h1 className="text-2xl font-bold mt-4" style={{ color: '#1a1a1a' }}>Service Desk Reports</h1>
          <p className="text-sm mt-2" style={{ color: '#6B6B6B' }}>Analyze service desk group performance and team metrics</p>
        </div>

        <div className="flex-1 overflow-auto p-6">
          <div className="grid grid-cols-2 gap-6">
            {serviceDeskReports.map(report => {
