...
export default function AgentProductivityReportPage() {
  return (
    <ReportWorkspaceLayout
      reportTitle="Agent Productivity Report"
    ...
    >
      <div className="space-y-6">
        <div className="p-8 rounded-lg border text-center" style={{ borderColor: '#E2E0DC', backgroundColor: '#F8F8F7', color: '#6B6B6B' }}>
          <p className="text-lg font-medium">Agent Productivity Report</p>
          <p className="text-sm mt-2">Agent task completion rates and efficiency metrics</p>
        </div>
