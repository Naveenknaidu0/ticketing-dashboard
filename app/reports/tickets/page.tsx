...
const ticketReports = [
  { id: 'status', name: 'Ticket Status', path: '/reports/tickets/status', icon: BarChart3 },
  { id: 'priority', name: 'Priority Analysis', path: '/reports/tickets/priority', icon: TrendingUp },
  { id: 'type-analysis', name: 'Type Analysis', path: '/reports/tickets/type-analysis', icon: FileText },
  { id: 'aging', name: 'Ticket Aging', path: '/reports/tickets/aging', icon: Calendar },
]
    ...
    <AppShell>
      <div className="flex flex-col h-full">
        <div className="border-b p-6" style={{ borderColor: '#E2E0DC' }}>
          ...
          <h1 className="text-2xl font-bold mt-4" style={{ color: '#1a1a1a' }}>Ticket Reports</h1>
          <p className="text-sm mt-2" style={{ color: '#6B6B6B' }}>Analyze ticket distribution, trends, and aging patterns</p>
        </div>
