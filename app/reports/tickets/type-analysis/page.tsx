...
export default function TypeAnalysisReportPage() {
  return (
    <ReportWorkspaceLayout
      reportTitle="Ticket Type Analysis Report"
      parentRoute="/reports/tickets"
      breadcrumbItems={[
        { label: 'Reports', href: '/reports' },
        { label: 'Ticket Reports', href: '/reports/tickets' },
        { label: 'Ticket Type Analysis' },
      ]}
    ...
    >
      <div className="space-y-6">
        <div className="p-8 rounded-lg border text-center" style={{ borderColor: '#E2E0DC', backgroundColor: '#F8F8F7', color: '#6B6B6B' }}>
          <p className="text-lg font-medium">Ticket Type Analysis Report</p>
          <p className="text-sm mt-2">Analysis of tickets by type and classification</p>
        </div>
